...
ARG RESTY_CONFIG_OPTIONS_MORE="\
    ...
    --add-module=/build/modules/ngx_http_lower_upper_case_module \
...
RUN apk add -U tzdata \
    ...
    && patch -p1 < /build/patches/ngx_core_patches/ngx_http_slice_module_ext_1.21.4+.patch \
